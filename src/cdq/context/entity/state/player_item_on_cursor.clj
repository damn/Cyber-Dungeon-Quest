(ns cdq.context.entity.state.player-item-on-cursor
  (:require [gdl.context :refer [play-sound! mouse-on-stage-actor? button-just-pressed? draw-centered-image
            ...
            [cdq.context.entity.state.player-idle :refer [click-distance-tiles]]
...
(defn- item-place-position [ctx entity]
  (placement-point (:entity/position @entity)
                   ...
                   (- cdq.context.entity.state.player-idle/click-distance-tiles 0.1)))
